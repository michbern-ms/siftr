...
| All day | `siftr loop` | Auto-triages recent mail hourly until 8pm — digest stays manual |
...
| `siftr loop` | Auto-triage recent mail hourly until 8pm (digest stays manual) |
